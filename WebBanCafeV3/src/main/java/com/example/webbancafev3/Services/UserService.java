...
import com.example.webbancafev3.Role;
import com.example.webbancafev3.Models.User;
import com.example.webbancafev3.Repositories.IRoleRepository;
import com.example.webbancafev3.Repositories.IUserRepository;
...
public class UserService implements UserDetailsService
{
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException
    {
        ...
        return org.springframework.security.core.userdetails.User.withUsername(user.getUsername()).password(user.getPassword())
                .authorities(user.getAuthorities()).accountExpired(!user.isAccountNonExpired()).accountLocked(!user.isAccountNonLocked())
